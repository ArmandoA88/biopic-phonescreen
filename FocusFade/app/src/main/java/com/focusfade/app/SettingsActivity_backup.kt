// This is a backup of the original SettingsActivity before crash fixes
        ...
        try {
            ...
            binding.apply {
                ...
                buttonSelectBlur.setOnClickListener {
                    try {
                        val serviceIntent = Intent(this@SettingsActivityBackup, com.focusfade.app.service.BlurOverlayService::class.java)
                        serviceIntent.action = "SET_OVERLAY_MODE"
                        serviceIntent.putExtra("mode", 0)
                        startService(serviceIntent)
                        Toast.makeText(this@SettingsActivityBackup, "Blur overlay selected", Toast.LENGTH_SHORT).show()
                    } catch (e: Exception) {
                        Log.e(TAG, "Error selecting blur mode", e)
                        Toast.makeText(this@SettingsActivityBackup, "Error selecting blur mode", Toast.LENGTH_SHORT).show()
                    }
                }
                buttonSelectColorShift.setOnClickListener {
                    try {
                        ...
                        startService(serviceIntent)
                        Toast.makeText(this@SettingsActivityBackup, "Color shift overlay selected", Toast.LENGTH_SHORT).show()
                    } catch (e: Exception) {
                        Log.e(TAG, "Error selecting color shift mode", e)
                        Toast.makeText(this@SettingsActivityBackup, "Error selecting color shift mode", Toast.LENGTH_SHORT).show()
                    }
                }
                buttonSelectPattern.setOnClickListener {
                    try {
                        ...
                        startService(serviceIntent)
                        Toast.makeText(this@SettingsActivityBackup, "Pattern overlay selected", Toast.LENGTH_SHORT).show()
                    } catch (e: Exception) {
                        Log.e(TAG, "Error selecting pattern mode", e)
                        Toast.makeText(this@SettingsActivityBackup, "Error selecting pattern mode", Toast.LENGTH_SHORT).show()
                    }
                }
            }
    ...
    private fun observeSettings() {
        lifecycleScope.launch {
            try {
                ...
                Toast.makeText(this@SettingsActivityBackup, "Error loading settings", Toast.LENGTH_SHORT).show()
            }
        }
    }
        ...
        TimePickerDialog(
            ...
            { _, hourOfDay, minute ->
                lifecycleScope.launch {
                    ...
                    DailyResetScheduler.rescheduleDailyReset(this@SettingsActivityBackup, settingsManager)
                    Toast.makeText(this@SettingsActivityBackup, "Daily reset time updated", Toast.LENGTH_SHORT).show()
                }
            },
            currentHour,
            currentMinute,
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Reset") { _, _ ->
                lifecycleScope.launch {
                    ...
                    DailyResetScheduler.rescheduleDailyReset(this@SettingsActivityBackup, settingsManager)
                    Toast.makeText(this@SettingsActivityBackup, "Settings reset to defaults", Toast.LENGTH_SHORT).show()
                }
            }
